...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train and evaluate all models, get the best model and its name")
    ...
    main(args.train_dataset_path, args.test_dataset_path,)
